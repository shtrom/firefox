...
Additionally, [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe/)
...
The easiest way to integrate ESLint with VIM is using the [Syntastic plugin](https://github.com/vim-syntastic/syntastic).
...
You can also use something like [eslint_d](https://github.com/mantoni/eslint_d.js#editor-integration) which should
