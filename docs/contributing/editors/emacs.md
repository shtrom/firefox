...
See [the devtools documentation](https://wiki.mozilla.org/DevTools/CodingStandards#Running_ESLint_in_Emacs)
...
[rtags github repo](https://github.com/Andersbakken/rtags).
...
[irony-mode github repo](https://github.com/Sarcasm/irony-mode).
...
It is recommended to use [this fork of irony-mode](https://github.com/Hylen/irony-mode/tree/compilation-database-guessing-4-pull-request),
which requires the boost System and Filesystem libraries.

[Checking the bug to get this patch into the mainline of irony-mode](https://github.com/Sarcasm/irony-mode/issues/176)
...
[projectile github repo](https://github.com/bbatsov/projectile).
...
[gdb-many-windows](https://www.gnu.org/software/emacs/manual/html_node/emacs/GDB-User-Interface-Layout.html).
