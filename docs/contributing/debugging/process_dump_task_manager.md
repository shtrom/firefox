...
: You need a Firefox version for which symbols are available from the
  ...
  [http://ftp.mozilla.org/pub/mozilla.o.../latest-trunk/](http://ftp.mozilla.org/pub/mozilla.org/firefox/nightly/latest-trunk/).
...
3. Right-click Firefox.exe and select "Create dump file". Task manager
