...
received by [Socorro](https://github.com/mozilla/socorro) which
[creates](https://github.com/mozilla/socorro/blob/master/socorro/processor/mozilla_processor_2015.py)
...
searchable on [crash-stats](https://crash-stats.mozilla.org/).
...
access, see the [Protected Data Access docs on Crash Stats](https://crash-stats.mozilla.org/documentation/protected_data_access/).
...
```{image} https://mdn.mozillademos.org/files/13579/Details1.png
```
...
API](https://crash-stats.mozilla.org/api/SuperSearchFields/) and can be
[modified in super_search_fields.py](https://github.com/mozilla-services/socorro/blob/main/socorro/external/es/super_search_fields.py)
or by writing up a [bug in Socorro](https://bugzilla.mozilla.org/enter_bug.cgi?format=__standard__&product=Socorro).
...
See [this
file](https://github.com/mozilla-services/socorro/blob/master/socorro/signature/README.rst)
...
(There is a [bug
report](https://bugzilla.mozilla.org/show_bug.cgi?id=1493342) open
...
later](https://bugzilla.mozilla.org/show_bug.cgi?id=1401517) (using
...
```{image} https://mdn.mozillademos.org/files/13581/Details2.png
```
...
```{image} https://mdn.mozillademos.org/files/13583/Details3.png
```
...
```{image} https://mdn.mozillademos.org/files/13593/Modules1.png
```
...
[This page](https://support.mozilla.org/en-US/kb/helping-crashes)
...
```{image} https://mdn.mozillademos.org/files/13595/RawDump1.png
```

For users with minidump access, the second part of the Raw Dump tab has
some links, as the following screenshot shows.

```{image} https://mdn.mozillademos.org/files/14047/raw-dump-links.png
```
...
```{image} https://mdn.mozillademos.org/files/13599/Extensions1.png
```
