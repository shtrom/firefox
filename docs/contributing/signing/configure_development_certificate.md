...
Developer account, you can [request access through Bugzilla](https://bugzilla.mozilla.org/enter_bug.cgi?product=App%20Stores&component=App%20Store%20Access).
