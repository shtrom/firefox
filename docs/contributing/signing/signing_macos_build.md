...
a bug [here](https://bugzilla.mozilla.org/enter_bug.cgi?product=App%20Stores&component=App%20Store%20Access)
...
## Example: Re-Signing Official Developer Edition With [rcodesign](https://crates.io/crates/apple-codesign) Using a pkcs12 Certificate Key Pair

More information about rcodesign can be found on the
[rust crate page](https://crates.io/crates/apple-codesign) or
[github repo](https://github.com/indygreg/apple-platform-rs). Certificates
