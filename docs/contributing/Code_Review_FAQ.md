...
- API/design review. Because APIs define the interactions between
  ...
  checklist](https://wiki.mozilla.org/WebAPI/WebIDL_Review_Checklist).
  ...
  [this wiki
  page](https://wiki.mozilla.org/WebAPI/ExposureGuidelines).
...
- License review. Does the code follow the [code licensing
  rules](https://www.mozilla.org/hacking/committer/committers-agreement.pdf)?
