...
.. list-table::
    ...
    * - Owner(s)
      -
        ...
        | `Andrew Overholt (overholt) <https://people.mozilla.org/s?query=overholt>`__
        | `Dave Townsend (mossop) <https://people.mozilla.org/s?query=mossop>`__
        | `Ben Bangert (benbangert) <https://people.mozilla.org/s?query=benbangert>`__
...
Code Review Policy
==================
Submodule governing the code review process, ensuring adherence to coding
...
=============================
Submodule focused on preventing and addressing performance regressions,
...
Android Components
~~~~~~~~~~~~~~~~~~
A collection of independent, reusable Android library components to make it
easier to build browsers and browser-like applications.
...
.. list-table::
    ...
    * - Owner(s)
      -
        ...
        | `Matt Tighe (matt-tighe) <https://people.mozilla.org/s?query=matt-tighe>`__
    * - Peer(s)
      -
        | `Kayacan Kaya (kaya) <https://people.mozilla.org/s?query=kaya>`__
    * - Includes
      -
        | `mobile/android/android-components/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/\*\*/\*>`__
    * - Review Group
      - `#android-reviewers <https://phabricator.services.mozilla.com/tag/android-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Nathan LaPré (nlapre) <https://people.mozilla.org/s?query=nlapre>`__
    * - Owner(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Emma Zühlcke (emz) <https://people.mozilla.org/s?query=emz>`__
    ...
    * - Review Group
      - `#anti-tracking <https://phabricator.services.mozilla.com/tag/anti-tracking/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Gabriel Bustamante (gabriel) <https://people.mozilla.org/s?query=gabriel>`__
    * - Owner(s) Emeritus
      - Aki Sasaki
    * - Includes
      -
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Alex Hochheiden (ahochheiden) <https://people.mozilla.org/s?query=ahochheiden>`__
    * - Owner(s) Emeritus
...
.. list-table::
    ...
    * - Review Group
      - `#taskgraph-reviewers <https://phabricator.services.mozilla.com/tag/taskgraph-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Simon Friedberger (sfriedberger) <https://people.mozilla.org/s?query=sfriedberger>`__
    * - Peer(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `edgul (edgul) <https://people.mozilla.org/s?query=edgul>`__
        | `Benjamin VanderSloot (bvandersloot) <https://people.mozilla.org/s?query=bvandersloot>`__
    * - Owner(s) Emeritus
      - Monica Chew
    * - Peer(s) Emeritus
      - Josh Matthews, Mike Connor, Dan Witte, Christian Biesinger, Shawn Wilsher, Ehsan Akhgari, Honza Bambas, Emma Zühlcke, Tom Schuster
    * - Includes
      -
    ...
    * - Review Group
      - `#cookies <https://phabricator.services.mozilla.com/tag/cookies/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Calixte Denizet (calixte) <https://people.mozilla.org/s?query=calixte>`__
        | `Alex Franchuk (afranchuk) <https://people.mozilla.org/s?query=afranchuk>`__
    * - Peer(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Greg Stoll (gstoll) <https://people.mozilla.org/s?query=gstoll>`__
    * - Owner(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Kagami Rosylight (saschanaz) <https://people.mozilla.org/s?query=saschanaz>`__
        | `Sean Feng (sefeng) <https://people.mozilla.org/s?query=sefeng>`__
    * - Owner(s) Emeritus
    ...
    * - Bugzilla Components
      - Core::DOM, Core::DOM: Core & HTML, Core::XSLT
    * - Review Group
      - `#dom-core <https://phabricator.services.mozilla.com/tag/dom-core/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Florian Quèze (florian) <https://people.mozilla.org/s?query=florian>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Makoto Kato (m_kato) <https://people.mozilla.org/s?query=m_kato>`__
        | `Olivia Hall (olivia) <https://people.mozilla.org/s?query=olivia>`__
    * - Owner(s) Emeritus
    ...
    * - Excludes
      -
        | `mobile/android/fenix/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/fenix/\*\*/\*>`__
        | `mobile/android/focus-android/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/focus-android/\*\*/\*>`__
        | `mobile/android/android-components/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/\*\*/\*>`__
    * - URL
    ...
    * - Bugzilla Components
      - GeckoView::General
    * - Review Group
      - `#geckoview-reviewers <https://phabricator.services.mozilla.com/tag/geckoview-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Glenn Watson (gw) <https://people.mozilla.org/s?query=gw>`__
        | `Lee Salzman (lsalzman) <https://people.mozilla.org/s?query=lsalzman>`__
    ...
    * - Bugzilla Components
      - Core::Graphics, Core::Graphics: Layers, Core::Graphics: Text, Core::Graphics:
        WebRender, Core::Graphics: Color Management, Core::Graphics: Canvas2D,
        Core::Graphics: CanvasWebGL
    * - Review Group
      - `#gfx-reviewers <https://phabricator.services.mozilla.com/tag/gfx-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Andrew Sutherland (asuth) <https://people.mozilla.org/s?query=asuth>`__
        | `Jari Jalkanen (jjalkanen) <https://people.mozilla.org/s?query=jjalkanen>`__
    * - Owner(s) Emeritus
      - Ben Turner
    * - Peer(s) Emeritus
    ...
    * - Bugzilla Components
      - Core::DOM: IndexedDB
    * - Review Group
      - `#dom-storage-reviewers <https://phabricator.services.mozilla.com/tag/dom-storage-reviewers/>`__
...
.. list-table::
    ...
    * - Bugzilla Components
      - Core::IPC
    * - Review Group
      - `#ipc-reviewers <https://phabricator.services.mozilla.com/tag/ipc-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s) Emeritus
      - Andreas Gal, Ashley Hauck, Benjamin Bouvier, Bill McCloskey, Blake Kaplan, Brian Hackett, Caroline Cullen, Dan Gohman, David Anderson, Eddy Bruel, Eric Faust, Hannes Verschore, Igor Bukanov, Jeff Walden, Kannan Vijayan, Nicholas Nethercote, Nick Fitzgerald, Niko Matsakis, Sean Stangl, Shu-yu Guo, Till Schneidereit
    * - Includes
      -
        | `js/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=js/\*\*/\*>`__
    * - Excludes
      -
    ...
    * - Bugzilla Components
      - Core::JavaScript Engine, Core::JavaScript Engine: JIT, Core::JavaScript: GC,
        Core::JavaScript: Internationalization API, Core::JavaScript: Standard Library,
        Core::JavaScript: WebAssembly, Core::js-ctypes
    * - Review Group
      - `#spidermonkey-reviewers <https://phabricator.services.mozilla.com/tag/spidermonkey-reviewers/>`__
...
.. list-table::
    ...
    * - Review Group
      - `#layout-reviewers <https://phabricator.services.mozilla.com/tag/layout-reviewers/>`__
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Implementation of localStorage & sessionStorage exposed only on window objects
...
.. list-table::
    ...
    * - Includes
      -
        | `dom/localstorage/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/localstorage/\*\*/\*>`__
        | `dom/storage/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/storage/\*\*/\*>`__
...
.. list-table::
    ...
    * - Owner(s)
      -
        ...
        | `Tarek Ziadé (tarek) <https://people.mozilla.org/s?query=tarek>`__
    * - Peer(s)
      -
        | `Greg Tatum (gregtatum) <https://people.mozilla.org/s?query=gregtatum>`__
    * - Includes
      -
        | `browser/components/genai/ <https://searchfox.org/mozilla-central/search?q=&path=browser/components/genai/>`__
        | `toolkit/components/aboutinference/ <https://searchfox.org/mozilla-central/search?q=&path=toolkit/components/aboutinference/>`__
        | `toolkit/components/ml/ <https://searchfox.org/mozilla-central/search?q=&path=toolkit/components/ml/>`__
    * - Bugzilla Components
      - Core::Machine Learning
    * - Review Group
      - `#firefox-ai-ml-reviewers <https://phabricator.services.mozilla.com/tag/firefox-ai-ml-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Frédéric Wang (fred.wang) <https://people.mozilla.org/s?query=fred.wang>`__
        | `Jonathan Kew (jfkthame) <https://people.mozilla.org/s?query=jfkthame>`__
    * - Owner(s) Emeritus
      - Karl Tomlinson
    * - Peer(s) Emeritus
...
.. list-table::
    ...
    * - Bugzilla Components
      - Core::Audio/Video
    * - Review Group
      - `#media-playback-reviewers <https://phabricator.services.mozilla.com/tag/media-playback-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Paul Bone (pbone) <https://people.mozilla.org/s?query=pbone>`__
    * - Peer(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `James Teh (Jamie) <https://people.mozilla.org/s?query=Jamie>`__
        | `Nick Rishel (nrishel) <https://people.mozilla.org/s?query=nrishel>`__
    * - Owner(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Kershaw Chang (kershaw) <https://people.mozilla.org/s?query=kershaw>`__
        | `Randell Jesup (jesup) <https://people.mozilla.org/s?query=jesup>`__
        | `Sunil Mayya (sunil) <https://people.mozilla.org/s?query=sunil>`__
    * - Owner(s) Emeritus
    ...
    * - Bugzilla Components
      - Core::Networking, Core::Networking: Cache, Core::Networking: Cookies,
        Core::Networking: File, Core::Networking: HTTP, Core::Networking: JAR,
        Core::Networking: Proxy, Core::Networking: Websockets, Core::DOM: Networking
    * - Review Group
      - `#necko-reviewers <https://phabricator.services.mozilla.com/tag/necko-reviewers/>`__
...
Core: Notifications
~~~~~~~~~~~~~~~~~~~
The infrastructure for Web Notifications API and the Firefox Desktop
notifications.
...
.. list-table::
    ...
    * - Includes
      -
        | `dom/notification/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/notification/\*\*/\*>`__
        | `toolkit/components/alerts/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=toolkit/components/alerts/\*\*/\*>`__
        | `toolkit/system/gnome/nsAlertsIconListener\* <https://searchfox.org/mozilla-central/search?q=&path=toolkit/system/gnome/nsAlertsIconListener\*>`__
        | `toolkit/system/gnome/nsSystemAlertsService\* <https://searchfox.org/mozilla-central/search?q=&path=toolkit/system/gnome/nsSystemAlertsService\*>`__
        | `widget/windows/ToastNotification\* <https://searchfox.org/mozilla-central/search?q=&path=widget/windows/ToastNotification\*>`__
        | `widget/cocoa/OSXNotificationCenter\* <https://searchfox.org/mozilla-central/search?q=&path=widget/cocoa/OSXNotificationCenter\*>`__
    * - Group
      - dev-platform
    * - Bugzilla Components
...
.. list-table::
    ...
    * - Review Group
      - `#permissions-reviewers <https://phabricator.services.mozilla.com/tag/permissions-reviewers/>`__
...
.. list-table::
    ...
    * - Includes
      -
        ...
        | `dom/interfaces/push/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/interfaces/push/\*\*/\*>`__
    * - Bugzilla Components
      - Core::DOM: Push Subscriptions

Core: Quota Manager
~~~~~~~~~~~~~~~~~~~
Centralized quota tracked storage management and implementation of
StorageManager.
...
.. list-table::
    ...
    * - Includes
      -
        | `dom/quota/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/quota/\*\*/\*>`__
        | `dom/simpledb/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/simpledb/\*\*/\*>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Anna Weine (anna.weine) <https://people.mozilla.org/s?query=anna.weine>`__
    ...
    * - Review Group
      - `#nss-reviewers <https://phabricator.services.mozilla.com/tag/nss-reviewers/>`__
...
.. list-table::
    ...
    * - Review Group
      - `#static-analysis-reviewers <https://phabricator.services.mozilla.com/tag/static-analysis-reviewers/>`__
...
.. list-table::
    ...
    * - Includes
      -
        ...
        | `toolkit/components/kvstore/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=toolkit/components/kvstore/\*\*/\*>`__
        | `toolkit/modules/Sqlite.sys.mjs <https://searchfox.org/mozilla-central/search?q=&path=toolkit/modules/Sqlite.sys.mjs>`__
    * - Group
      - dev-platform
    * - URL
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Xidorn Quan (xidorn) <https://people.mozilla.org/s?query=xidorn>`__
        | `Boris Chiou (boris) <https://people.mozilla.org/s?query=boris>`__
        | `David Shin (dshin) <https://people.mozilla.org/s?query=dshin>`__
        | `Tiaan Louw (tlouw) <https://people.mozilla.org/s?query=tlouw>`__
        | `Zach Hoffman (zrhoffman) <https://people.mozilla.org/s?query=zrhoffman>`__
    * - Owner(s) Emeritus
    ...
    * - Review Group
      - `#firefox-style-system-reviewers <https://phabricator.services.mozilla.com/tag/firefox-style-system-reviewers/>`__
...
.. list-table::
    ...
    * - Includes
      -
        | `supply-chain/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=supply-chain/\*\*/\*>`__
        | `.cargo/audit.toml <https://searchfox.org/mozilla-central/search?q=&path=.cargo/audit.toml>`__
    * - Group
      - dev-platform
    * - Bugzilla Components
      - Firefox Build System::General
    * - Review Group
      - `#supply-chain-reviewers <https://phabricator.services.mozilla.com/tag/supply-chain-reviewers/>`__
...
.. list-table::
    ...
    * - Bugzilla Components
      - Core::SVG
    * - Review Group
      - `#firefox-svg-reviewers <https://phabricator.services.mozilla.com/tag/firefox-svg-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Eden Chuang (edenchuang) <https://people.mozilla.org/s?query=edenchuang>`__
        | `Jens Stutte (jstutte) <https://people.mozilla.org/s?query=jstutte>`__
        | `Olli Pettay (smaug) <https://people.mozilla.org/s?query=smaug>`__
    * - Owner(s) Emeritus
    ...
    * - Includes
      -
        | `dom/serviceworkers/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/serviceworkers/\*\*/\*>`__
    ...
    * - Bugzilla Components
      - Core::DOM: Service Workers, Core::DOM: Workers
    * - Review Group
      - `#dom-worker-reviewers <https://phabricator.services.mozilla.com/tag/dom-worker-reviewers/>`__
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Jim Blandy (jimb) <https://people.mozilla.org/s?query=jimb>`__
    * - Peer(s)
      -
        | `Erich Gubler (ErichDonGubler) <https://people.mozilla.org/s?query=ErichDonGubler>`__
        | `Kelsey Gilbert (jgilbert) <https://people.mozilla.org/s?query=jgilbert>`__
        | `Nicolas Silva (nical) <https://people.mozilla.org/s?query=nical>`__
        | `Teodor Tanasoaia (teoxoy) <https://people.mozilla.org/s?query=teoxoy>`__
        | `Andy Leiserson (aleiserson) <https://people.mozilla.org/s?query=aleiserson>`__
    * - Owner(s) Emeritus
      - Dzmitry Malyshau
    * - Peer(s) Emeritus
      - Josh Groves
    * - Includes
      -
        | `dom/webidl/WebGPU.webidl <https://searchfox.org/mozilla-central/search?q=&path=dom/webidl/WebGPU.webidl>`__
        | `dom/webgpu/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=dom/webgpu/\*\*/\*>`__
        | `gfx/wgpu_bindings/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=gfx/wgpu_bindings/\*\*/\*>`__
        | `third_party/rust/naga/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=third_party/rust/naga/\*\*/\*>`__
        | `third_party/rust/wgpu-\*/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=third_party/rust/wgpu-\*/\*\*/\*>`__
        | `testing/web-platform/tests/webgpu/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=testing/web-platform/tests/webgpu/\*\*/\*>`__
        | `testing/web-platform/meta/webgpu/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=testing/web-platform/meta/webgpu/\*\*/\*>`__
        | `testing/web-platform/mozilla/tests/webgpu/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=testing/web-platform/mozilla/tests/webgpu/\*\*/\*>`__
        | `testing/web-platform/mozilla/meta/webgpu/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=testing/web-platform/mozilla/meta/webgpu/\*\*/\*>`__
    * - Group
      - dev-platform
    * - URL
    ...
    * - Review Group
      - `#webgpu-reviewers <https://phabricator.services.mozilla.com/tag/webgpu-reviewers/>`__
...
.. list-table::
    ...
    * - Bugzilla Components
      - Core::Widget: Cocoa
    * - Review Group
      - `#mac-reviewers <https://phabricator.services.mozilla.com/tag/mac-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `David Parks (handyman) <https://people.mozilla.org/s?query=handyman>`__
        | `Molly Howell (molly) <https://people.mozilla.org/s?query=molly>`__
    * - Owner(s) Emeritus
      - Jim Mathies
    * - Peer(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `deanis74 <https://people.mozilla.org/s?query=deanis74>`__
    * - Owner(s) Emeritus
      - Neil Rashbrook
    * - Peer(s) Emeritus
      - Josh 'timeless' Soref
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Beth Rennie (beth) <https://people.mozilla.org/s?query=beth>`__
        | `Jens Stutte (jstutte) <https://people.mozilla.org/s?query=jstutte>`__
        | `Andrew McCreight (mccr8) <https://people.mozilla.org/s?query=mccr8>`__
        | `Emilio Cobos Álvarez (emilio) <https://people.mozilla.org/s?query=emilio>`__
    * - Owner(s) Emeritus
    ...
    * - Includes
      -
        | `dom/chrome-webidl/IOUtils.webidl <https://searchfox.org/mozilla-central/search?q=&path=dom/chrome-webidl/IOUtils.webidl>`__
        | `dom/chrome-webidl/PathUtils.webidl <https://searchfox.org/mozilla-central/search?q=&path=dom/chrome-webidl/PathUtils.webidl>`__
        ...
        | `xpcom/io/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=xpcom/io/\*\*/\*>`__
        | `xpcom/ioutils/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=xpcom/ioutils/\*\*/\*>`__
    ...
    * - URL
      - :ref:`XPCOM`
    * - Bugzilla Components
      - Core::XPCOM, Toolkit::IOUtils and PathUtils
    * - Review Group
      - `#xpcom-reviewers <https://phabricator.services.mozilla.com/tag/xpcom-reviewers/>`__
...
.. list-table::
    ...
    * - Bugzilla Components
      - Firefox, Toolkit
    * - Review Group
      - `#firefox-desktop-core-reviewers <https://phabricator.services.mozilla.com/tag/firefox-desktop-core-reviewers/>`__
...
.. list-table::
    ...
    * - Review Group
      - `#extension-reviewers <https://phabricator.services.mozilla.com/tag/extension-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Marco Bonardo (mak) <https://people.mozilla.org/s?query=mak>`__
        | `Mark Banner (standard8) <https://people.mozilla.org/s?query=standard8>`__
        | `James Teow (jteow) <https://people.mozilla.org/s?query=jteow>`__
    * - Includes
      -
        | `browser/components/urlbar/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/components/urlbar/\*\*/\*>`__
        | `browser/themes/shared/urlbar\* <https://searchfox.org/mozilla-central/search?q=&path=browser/themes/shared/urlbar\*>`__
    * - Bugzilla Components
      - Firefox::Address Bar
    * - Review Group
      - `#urlbar-reviewers <https://phabricator.services.mozilla.com/tag/urlbar-reviewers/>`__
...
.. list-table::
    ...
    * - Review Group
      - `#application-update-reviewers <https://phabricator.services.mozilla.com/tag/application-update-reviewers/>`__
...
.. list-table::
    ...
    * - Includes
      -
        | `browser/components/pagedata/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/components/pagedata/\*\*/\*>`__
    ...
    * - Review Group
      - `#places-reviewers <https://phabricator.services.mozilla.com/tag/places-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `cmkm <https://people.mozilla.org/s?query=cmkm>`__
        | `Emilio Cobos Álvarez (emilio) <https://people.mozilla.org/s?query=emilio>`__
        | `Hanna Jones (hjones) <https://people.mozilla.org/s?query=hjones>`__
        | `Itiel (itiel_yn8) <https://people.mozilla.org/s?query=itiel_yn8>`__
        | `Julian Gaibler (Julian) <https://people.mozilla.org/s?query=Julian>`__
        | `Jules Simplicio (jules) <https://people.mozilla.org/s?query=jules>`__
    ...
    * - Review Group
      - `#desktop-theme-reviewers <https://phabricator.services.mozilla.com/tag/desktop-theme-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Sarah Clements (sclements) <https://people.mozilla.org/s?query=sclements>`__
        | `DJ (dwalker) <https://people.mozilla.org/s?query=dwalker>`__
        | `cmkm <https://people.mozilla.org/s?query=cmkm>`__
    * - Owner(s) Emeritus
      - Jared Wein
    * - Peer(s) Emeritus
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Charlie Humphreys (charlie) <https://people.mozilla.org/s?query=charlie>`__
        | `Daniel Thorn (relud) <https://people.mozilla.org/s?query=relud>`__
    * - Owner(s) Emeritus
      - Michael Cooper
    * - Includes
      -
    ...
    * - Review Group
      - `#nimbus-reviewers <https://phabricator.services.mozilla.com/tag/nimbus-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Sam Foster (sfoster) <https://people.mozilla.org/s?query=sfoster>`__
        | `Kelly Cochrane (kcochrane) <https://people.mozilla.org/s?query=kcochrane>`__
        | `Jonathan Sudiaman (jsudiaman) <https://people.mozilla.org/s?query=jsudiaman>`__
    * - Includes
      -
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Issam Mani (issammani) <https://people.mozilla.org/s?query=issammani>`__
        | `Janika Neuberger (janika) <https://people.mozilla.org/s?query=janika>`__
    * - Owner(s) Emeritus
...
====================
The system for delivering in-product messaging and onboarding including
Activity Stream Router, about:welcome, UI tour.
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Ed Lee (Mardak) <https://people.mozilla.org/s?query=Mardak>`__
        | `Dan Mosedale (dmosedale) <https://people.mozilla.org/s?query=dmosedale>`__
        | `Shane Hughes (aminomancer) <https://people.mozilla.org/s?query=aminomancer>`__
    * - Owner(s) Emeritus
      - Ed Lee
    * - Peer(s) Emeritus
    ...
    * - Includes
      -
        | `browser/components/asrouter/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/components/asrouter/\*\*/\*>`__
        | `browser/components/aboutwelcome/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/components/aboutwelcome/\*\*/\*>`__
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Ray Kraesig (rkraesig) <https://people.mozilla.org/s?query=rkraesig>`__
    * - Peer(s)
      -
        | `Molly Howell (molly) <https://people.mozilla.org/s?query=molly>`__
        | `Greg Stoll (gstoll) <https://people.mozilla.org/s?query=gstoll>`__
...
.. list-table::
    ...
    * - Includes
      -
        ...
        | `toolkit/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=toolkit/\*\*/\*>`__
    * - Review Group
      - `#fluent-reviewers <https://phabricator.services.mozilla.com/tag/fluent-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Nathan Barrett (nbarrett) <https://people.mozilla.org/s?query=nbarrett>`__
        | `Maxx Crawford (maxx) <https://people.mozilla.org/s?query=maxx>`__
    * - Owner(s) Emeritus
      - Ed Lee
    * - Peer(s) Emeritus
    ...
    * - Includes
      -
        ...
        | `browser/extensions/newtab/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/extensions/newtab/\*\*/\*>`__
    * - Bugzilla Components
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Johannes (joschmidt) <https://people.mozilla.org/s?query=joschmidt>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Stephanie Cunnane (scunnane) <https://people.mozilla.org/s?query=scunnane>`__
    * - Peer(s) Emeritus
      - Michael de Boer
    * - Includes
      -
    ...
    * - Bugzilla Components
      - Firefox::Search
    * - Review Group
      - `#search-reviewers <https://phabricator.services.mozilla.com/tag/search-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `DJ (dwalker) <https://people.mozilla.org/s?query=dwalker>`__
        | `Nikki Sharpley (nikkis) <https://people.mozilla.org/s?query=nikkis>`__
        | `Jeremy Swinarton (jswinarton) <https://people.mozilla.org/s?query=jswinarton>`__
    * - Owner(s) Emeritus
    ...
    * - Review Group
      - `#sessionstore-reviewers <https://phabricator.services.mozilla.com/tag/sessionstore-reviewers/>`__
...
.. list-table::
    ...
    * - Review Group
      - `#preferences-reviewers <https://phabricator.services.mozilla.com/tag/preferences-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        ...
        | `Niklas Baumgardner (niklas) <https://people.mozilla.org/s?query=niklas>`__
        | `Jeremy Swinarton (jswinarton) <https://people.mozilla.org/s?query=jswinarton>`__
        | `Stephen Thompson (sthompson) <https://people.mozilla.org/s?query=sthompson>`__
        | `Sarah Clements (sclements) <https://people.mozilla.org/s?query=sclements>`__
    * - Peer(s) Emeritus
      - Jared Wein, Matthew N, Mike Conley
    * - Includes
      -
        | `browser/components/tabbrowser/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/components/tabbrowser/\*\*/\*>`__
        | `browser/themes/shared/tabbrowser/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/themes/shared/tabbrowser/\*>`__
    * - Bugzilla Components
...
.. list-table::
    ...
    * - Bugzilla Components
      - Firefox::Installer
    * - Review Group
      - `#browser-installer-reviewers <https://phabricator.services.mozilla.com/tag/browser-installer-reviewers/>`__
...
.. list-table::
    ...
    * - Bugzilla Components
      - DevTools
    * - Review Group
      - `#devtools-reviewers <https://phabricator.services.mozilla.com/tag/devtools-reviewers/>`__
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Jeff Boek (boek) <https://people.mozilla.org/s?query=boek>`__
        | `Gabriel Luong (gl) <https://people.mozilla.org/s?query=gl>`__
    * - Peer(s)
      -
        | `Roger Yang (royang) <https://people.mozilla.org/s?query=royang>`__
        | `Rahul Sainani (rsainani) <https://people.mozilla.org/s?query=rsainani>`__
    * - Includes
      -
        | `mobile/android/fenix/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/fenix/\*\*/\*>`__
...
Fenix - Add-ons
===============
Submodule for the add-ons code in Firefox for Android.
...
.. list-table::
    ...
    * - Includes
      -
        | `mobile/android/android-components/components/browser/engine-gecko/src/\*/java/mozilla/components/browser/engine/gecko/webextension/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/browser/engine-gecko/src/\*/java/mozilla/components/browser/engine/gecko/webextension/\*>`__
        | `mobile/android/android-components/components/browser/state/src/\*/java/mozilla/components/browser/state/state/extension/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/browser/state/src/\*/java/mozilla/components/browser/state/state/extension/\*>`__
        | `mobile/android/android-components/components/concept/engine/src/\*/java/mozilla/components/concept/engine/webextension/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/concept/engine/src/\*/java/mozilla/components/concept/engine/webextension/\*>`__
        | `mobile/android/android-components/components/feature/addons/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/feature/addons/\*\*/\*>`__
        | `mobile/android/android-components/components/support/webextensions/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/support/webextensions/\*\*/\*>`__
        | `mobile/android/android-components/samples/browser/src/\*/java/org/mozilla/samples/browser/addons/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/samples/browser/src/\*/java/org/mozilla/samples/browser/addons/\*>`__
        | `mobile/android/fenix/app/src/\*/java/org/mozilla/fenix/addons/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/fenix/app/src/\*/java/org/mozilla/fenix/addons/\*>`__
        | `mobile/android/fenix/app/src/\*/java/org/mozilla/fenix/extension/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/fenix/app/src/\*/java/org/mozilla/fenix/extension/\*>`__
    * - Bugzilla Components
      - Firefox for Android :: WebExtensions, WebExtensions :: Android
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Mihai Adrian Carare (mcarare) <https://people.mozilla.org/s?query=mcarare>`__
        | `Roger Yang (royang) <https://people.mozilla.org/s?query=royang>`__
    * - Peer(s)
      -
        | `Iorga Gabriel (giorga) <https://people.mozilla.org/s?query=giorga>`__
    * - Includes
      -
        | `mobile/android/focus-android/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/focus-android/\*\*/\*>`__
...
.. list-table::
    ...
    * - Includes
      -
        | `eslint\*.config.mjs <https://searchfox.org/mozilla-central/search?q=&path=eslint\*.config.mjs>`__
        ...
        | `.prettier\* <https://searchfox.org/mozilla-central/search?q=&path=.prettier\*>`__
        | `.stylelint\* <https://searchfox.org/mozilla-central/search?q=&path=.stylelint\*>`__
    * - Review Group
      - `#frontend-codestyle-reviewers <https://phabricator.services.mozilla.com/tag/frontend-codestyle-reviewers/>`__
...
.. list-table::
    ...
    * - Bugzilla Components
      - Remote Protocol :: CDP
    * - Review Group
      - `#webdriver-reviewers <https://phabricator.services.mozilla.com/tag/webdriver-reviewers/>`__
...
Talos, MozPerfTest, AWSY, JSShell, mach try perf, etc.. See our PerfDocs for
more information  on the owners/peers of the various components (linked below).
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Andrej (aglavic) <https://people.mozilla.org/s?query=aglavic>`__
    ...
    * - Includes
      -
        ...
        | `testing/jsshell/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=testing/jsshell/\*\*/\*>`__
    ...
    * - Review Group
      - `#perftest-reviewers <https://phabricator.services.mozilla.com/tag/perftest-reviewers/>`__
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Alessio Placitelli (Dexter) <https://people.mozilla.org/s?query=Dexter>`__
...
WebCompat Addons
================
Compatibility interventions (webcompat system addon) and bug reporting
capabilities (Report Site Issue addon).
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Dennis Schubert (denschub) <https://people.mozilla.org/s?query=denschub>`__
        | `Thomas Wisniewski (twisniewski) <https://people.mozilla.org/s?query=twisniewski>`__
    * - Peer(s)
      -
        | `Ksenia Berezina (ksenia) <https://people.mozilla.org/s?query=ksenia>`__
    * - Peer(s) Emeritus
      - Mike Taylor
    * - Includes
      -
        | `browser/extensions/webcompat <https://searchfox.org/mozilla-central/search?q=&path=browser/extensions/webcompat>`__
        | `mobile/android/android-components/components/feature/webcompat <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/feature/webcompat>`__
        | `mobile/android/android-components/components/feature/webcompat-reporter <https://searchfox.org/mozilla-central/search?q=&path=mobile/android/android-components/components/feature/webcompat-reporter>`__
        | `toolkit/components/reportbrokensite <https://searchfox.org/mozilla-central/search?q=&path=toolkit/components/reportbrokensite>`__
        | `https://github.com/mozilla-extensions/webcompat-addon <https://searchfox.org/mozilla-central/search?q=&path=https://github.com/mozilla-extensions/webcompat-addon>`__
    * - Group
      - compatibility
    * - URL
      - https://wiki.mozilla.org/Compatibility/System_Addon
    * - Bugzilla Components
      - Web Compatibility::Interventions, Web Compatibility::Tooling & Investigations
    * - Review Group
      - `#webcompat-reviewers <https://phabricator.services.mozilla.com/tag/webcompat-reviewers/>`__
...
Translation
~~~~~~~~~~~
Support for translation in Firefox, and the infrastructure to train new
...
.. list-table::
    ...
    * - Peer(s)
      -
        | `Erik Nordin (nordzilla) <https://people.mozilla.org/s?query=nordzilla>`__
        | `Evgeny Pavlov (epavlov) <https://people.mozilla.org/s?query=epavlov>`__
        | `Marco Castelluccio (marco) <https://people.mozilla.org/s?query=marco>`__
    * - Includes
      -
        | `toolkit/components/translations/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=toolkit/components/translations/\*\*/\*>`__
        | `browser/components/translations/\*\*/\* <https://searchfox.org/mozilla-central/search?q=&path=browser/components/translations/\*\*/\*>`__
    * - Group
      - dev-platform
    * - URL
      - https://github.com/mozilla/firefox-translations-training https://github.com/mozilla/firefox-translations-models https://github.com/mozilla/firefox-translations-evaluations https://github.com/mozilla/firefox-translations
    * - Bugzilla Components
      - Firefox::Translation
    * - Review Group
      - `#translations-reviewers <https://phabricator.services.mozilla.com/tag/translations-reviewers/>`__

Tree Sheriffs
~~~~~~~~~~~~~
Tree Sheriffs aid developers to easily, quickly, and seamlessly land their code
in the proper location(s) and ensure that code does not break our automated
tests. In the service of this objective, the Sheriffs work closely with the
larger engineering organization to create and enforce landing policies that
increase productivity while maintaining an efficient and robust automated
testing system. Beyond the policy role, they have also become shepherds of
automation quality by monitoring intermittent failures, performing uplifts and
merges, and identifying poorly performing automation machines.
...
.. list-table::
    ...
    * - Owner(s)
      -
        | `Sebastian Hengst (aryx) <https://people.mozilla.org/s?query=aryx>`__
    * - Peer(s)
      -
        | `Ryan VanderMeulen (RyanVM) <https://people.mozilla.org/s?query=RyanVM>`__
    * - Peer(s) Emeritus
