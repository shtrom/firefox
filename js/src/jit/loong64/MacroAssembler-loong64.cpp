...
void MacroAssemblerLOONG64::wasmLoadImpl(const wasm::MemoryAccessDesc& access,
  ...
  switch (access.type()) {
    ...
    case Scalar::Uint32:
      ...
      break;
    case Scalar::Int64:
      fco = ma_load(output.gpr(), address, SizeDouble);
      break;
    case Scalar::Float64:
      fco = ma_fld_d(output.fpu(), address);
      break;
    case Scalar::Float32:
      fco = ma_fld_s(output.fpu(), address);
      break;
    default:
      MOZ_CRASH("unexpected array type");
  }
...
void MacroAssemblerLOONG64::wasmStoreImpl(const wasm::MemoryAccessDesc& access,
  ...
  switch (access.type()) {
    case Scalar::Int8:
    case Scalar::Uint8:
      fco = ma_store(value.gpr(), address, SizeByte);
      break;
    case Scalar::Int16:
    case Scalar::Uint16:
      fco = ma_store(value.gpr(), address, SizeHalfWord);
      break;
    case Scalar::Int32:
    case Scalar::Uint32:
      fco = ma_store(value.gpr(), address, SizeWord);
      break;
    case Scalar::Int64:
      fco = ma_store(value.gpr(), address, SizeDouble);
      break;
    case Scalar::Float64:
