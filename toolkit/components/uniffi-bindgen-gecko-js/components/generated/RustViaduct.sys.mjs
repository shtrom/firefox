...
const result = UniFFIScaffolding.callSync(
    206, // uniffi_viaduct_fn_func_allow_android_emulator_loopback
)
...
const result = UniFFIScaffolding.callSync(
    207, // uniffi_viaduct_fn_func_clear_ohttp_channels
)
return handleRustResult(
    result,
    (result) => undefined,
...
const result = UniFFIScaffolding.callSync(
    208, // uniffi_viaduct_fn_func_configure_default_ohttp_channels
)
return handleRustResult(
    result,
    (result) => undefined,
...
const result = UniFFIScaffolding.callSync(
    209, // uniffi_viaduct_fn_func_configure_ohttp_channel
...
const result = UniFFIScaffolding.callSync(
    210, // uniffi_viaduct_fn_func_init_backend
...
const result = UniFFIScaffolding.callSync(
    211, // uniffi_viaduct_fn_func_list_ohttp_channels
)
return handleRustResult(
    result,
...
const result = await UniFFIScaffolding.callAsync(
    212, // uniffi_viaduct_fn_func_send_ohttp_request
...
const result = UniFFIScaffolding.callSync(
    213, // uniffi_viaduct_fn_func_set_global_default_user_agent
...
export class BackendImpl extends Backend {
    ...
    async sendRequest(
        ...
        const result = await UniFFIScaffolding.callAsync(
            214, // uniffi_viaduct_fn_method_backend_send_request
