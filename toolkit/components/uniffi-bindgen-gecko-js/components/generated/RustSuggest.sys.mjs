...
const result = UniFFIScaffolding.callSync(
    148, // uniffi_suggest_fn_func_raw_suggestion_url_matches
...
export class SuggestStore extends SuggestStoreInterface {
    ...
    static init(
        ...
        const result = UniFFIScaffolding.callSync(
            149, // uniffi_suggest_fn_constructor_suggeststore_new
    ...
    async anyDismissedSuggestions() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            150, // uniffi_suggest_fn_method_suggeststore_any_dismissed_suggestions
    ...
    async clear() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            151, // uniffi_suggest_fn_method_suggeststore_clear
            FfiConverterTypeSuggestStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async clearDismissedSuggestions() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            152, // uniffi_suggest_fn_method_suggeststore_clear_dismissed_suggestions
            FfiConverterTypeSuggestStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async dismissByKey(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            153, // uniffi_suggest_fn_method_suggeststore_dismiss_by_key
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async dismissBySuggestion(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            154, // uniffi_suggest_fn_method_suggeststore_dismiss_by_suggestion
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async dismissSuggestion(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            155, // uniffi_suggest_fn_method_suggeststore_dismiss_suggestion
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async fetchGeonameAlternates(
        ...
        FfiConverterTypeGeoname.checkType(geoname);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            156, // uniffi_suggest_fn_method_suggeststore_fetch_geoname_alternates
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async fetchGeonames(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            157, // uniffi_suggest_fn_method_suggeststore_fetch_geonames
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async fetchGlobalConfig() {
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            158, // uniffi_suggest_fn_method_suggeststore_fetch_global_config
            FfiConverterTypeSuggestStore.lowerReceiver(this),
        )
        return handleRustResult(
            result,
    ...
    async fetchProviderConfig(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            159, // uniffi_suggest_fn_method_suggeststore_fetch_provider_config
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async ingest(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            160, // uniffi_suggest_fn_method_suggeststore_ingest
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    interrupt(
        ...
        const result = UniFFIScaffolding.callSync(
            161, // uniffi_suggest_fn_method_suggeststore_interrupt
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async isDismissedByKey(
        ...
        FfiConverterString.checkType(key);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            162, // uniffi_suggest_fn_method_suggeststore_is_dismissed_by_key
            FfiConverterTypeSuggestStore.lowerReceiver(this),
            FfiConverterString.lower(key),
        )
        return handleRustResult(
    ...
    async isDismissedBySuggestion(
        ...
        FfiConverterTypeSuggestion.checkType(suggestion);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            163, // uniffi_suggest_fn_method_suggeststore_is_dismissed_by_suggestion
            FfiConverterTypeSuggestStore.lowerReceiver(this),
            FfiConverterTypeSuggestion.lower(suggestion),
        )
        return handleRustResult(
    ...
    async query(
        ...
        const result = await UniFFIScaffolding.callAsyncWrapper(
            164, // uniffi_suggest_fn_method_suggeststore_query
            FfiConverterTypeSuggestStore.lowerReceiver(this),
    ...
    async queryWithMetrics(
        ...
        FfiConverterTypeSuggestionQuery.checkType(query);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            165, // uniffi_suggest_fn_method_suggeststore_query_with_metrics
            FfiConverterTypeSuggestStore.lowerReceiver(this),
            FfiConverterTypeSuggestionQuery.lower(query),
        )
        return handleRustResult(
...
export class SuggestStoreBuilder extends SuggestStoreBuilderInterface {
    ...
    static init() {
        ...
        const result = UniFFIScaffolding.callSync(
            166, // uniffi_suggest_fn_constructor_suggeststorebuilder_new
        )
        return handleRustResult(
            result,
    ...
    build() {
        ...
        const result = UniFFIScaffolding.callSync(
            167, // uniffi_suggest_fn_method_suggeststorebuilder_build
    ...
    async cachePath(
        ...
        FfiConverterString.checkType(path);
        const result = await UniFFIScaffolding.callAsyncWrapper(
            168, // uniffi_suggest_fn_method_suggeststorebuilder_cache_path
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
            FfiConverterString.lower(path),
        )
        return handleRustResult(
    ...
    dataPath(
        ...
        FfiConverterString.checkType(path);
        const result = UniFFIScaffolding.callSync(
            169, // uniffi_suggest_fn_method_suggeststorebuilder_data_path
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
            FfiConverterString.lower(path),
        )
        return handleRustResult(
    ...
    loadExtension(
        ...
        const result = UniFFIScaffolding.callSync(
            170, // uniffi_suggest_fn_method_suggeststorebuilder_load_extension
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
    ...
    remoteSettingsBucketName(
        ...
        const result = UniFFIScaffolding.callSync(
            171, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_bucket_name
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
    ...
    remoteSettingsServer(
        ...
        const result = UniFFIScaffolding.callSync(
            172, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_server
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
    ...
    remoteSettingsService(
        ...
        const result = UniFFIScaffolding.callSync(
            173, // uniffi_suggest_fn_method_suggeststorebuilder_remote_settings_service
            FfiConverterTypeSuggestStoreBuilder.lowerReceiver(this),
