  ...
  await runJSCacheTests([
    {
      ...
      items: [
        {
          file: "file_js_cache_charset.js",
          charset: "Shift_JIS",
          verifyText: "\u3042",
          events: [
            ev("load:source", "file_js_cache_charset.js"),
            ev("evaluate:classic", "file_js_cache_charset.js"),
            ev("diskcache:disabled", "file_js_cache_charset.js"),
          ],
        },
        {
          file: "file_js_cache_charset.js",
        ...
        },
        {
          ...
          events: [
            ev("load:source", "file_js_cache_charset.js"),
            ev("evaluate:classic", "file_js_cache_charset.js"),
            ev("diskcache:register", "file_js_cache_charset.js"),
            ev("diskcache:saved", "file_js_cache_charset.js", false),
          ],
        },
        ...
        // use the disk cache.
        {
          ...
          verifyText: "\u3042",
          events: [
            ev("load:diskcache", "file_js_cache_charset.js"),
            ev("evaluate:classic", "file_js_cache_charset.js"),
            ev("diskcache:disabled", "file_js_cache_charset.js"),
          ],
        },
      ...
      items: [
        {
          ...
          events: [
            ev("load:source", "file_js_cache_charset.js"),
            ev("memorycache:saved", "file_js_cache_charset.js"),
            ev("evaluate:classic", "file_js_cache_charset.js"),
        ...
        },
        {
          ...
          verifyText: "\u3042",
          events: [
            ev("load:memorycache", "file_js_cache_charset.js"),
            ev("evaluate:classic", "file_js_cache_charset.js"),
            ev("diskcache:noschedule"),
          ],
        },
