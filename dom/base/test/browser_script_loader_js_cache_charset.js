  ...
  await runJSCacheTests([
    {
      ...
      items: [
        {
          file: "file_js_cache_charset.sjs",
          charset: "Shift_JIS",
          verifyText: "\u3042",
          events: [
            ev("load:source", "file_js_cache_charset.sjs"),
            ev("evaluate:classic", "file_js_cache_charset.sjs"),
            ev("diskcache:disabled", "file_js_cache_charset.sjs"),
          ],
        },
        {
          file: "file_js_cache_charset.sjs",
        ...
        },
        {
          ...
          events: [
            ev("load:source", "file_js_cache_charset.sjs"),
            ev("evaluate:classic", "file_js_cache_charset.sjs"),
            ev("diskcache:register", "file_js_cache_charset.sjs"),
            ev("diskcache:saved", "file_js_cache_charset.sjs", false),
          ],
        },
        ...
        // use the disk cache.
        {
          ...
          verifyText: "\u3042",
          events: [
            ev("load:diskcache", "file_js_cache_charset.sjs"),
            ev("evaluate:classic", "file_js_cache_charset.sjs"),
            ev("diskcache:disabled", "file_js_cache_charset.sjs"),
          ],
        },
        // Loading with different charset should ignore the disk cache.
        ...
        // Loading with Shift_JIS should load source, and then save the disk
        // cache again.
        {
          file: "file_js_cache_charset.sjs",
          charset: "Shift_JIS",
      ...
      items: [
        {
          ...
          events: [
            ev("load:source", "file_js_cache_charset.sjs"),
            ev("memorycache:saved", "file_js_cache_charset.sjs"),
            ev("evaluate:classic", "file_js_cache_charset.sjs"),
        ...
        },
        {
          ...
          verifyText: "\u3042",
          events: [
            ev("load:memorycache", "file_js_cache_charset.sjs"),
            ev("evaluate:classic", "file_js_cache_charset.sjs"),
            ev("diskcache:noschedule"),
          ],
        },
        ...
        },
        {
          ...
          verifyText: "\u201a\xa0",
          events: [
            // The disk cache for no-charset was already overwritten,
            // and this loads source.
        ...
        },
        {
          ...
          verifyText: "\ufffd\ufffd",
          events: [
            // The disk cache for UTF-8 was already overwritten,
            // and this loads source.
            // The necko cache's fetch count already hits 4, and loading
            // source immediately created a disk cache.
            ev("load:source", "file_js_cache_charset.sjs"),
