  ...
  it("forwards prop updates to the custom element after creation", async () => {
    ...
    const state = {
      ...
      ExternalComponents: {
        components: [
          {
            type: "TEST_MESSAGE",
            tagName: "test-message-component",
            componentURL: "chrome://newtab/content/test-message.js",
            l10nURLs: [],
            attributes: {},
            cssVariables: {},
          },
    ...
    const { container, rerender } = render(
      <WrapWithProvider state={state}>
        <ExternalComponentWrapper
          type="TEST_MESSAGE"
          className="test-message-wrapper"
    ...
    // The element is created with the initial prop value.
    ...
    // The prop update is forwarded to the already-created element.
    await waitFor(() => {
      expect(
