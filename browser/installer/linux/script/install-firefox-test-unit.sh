...
tearDown() {
    ...
    unset -f curl wget check_cmd dpkg apt_cache_show_stub uname run_sudo retry \
        sleep id sudo _flaky install_apt \
        download_to_stdout check_url need_cmd find_l10n_package gpg mktemp \
        _apt_l10n_check apt_verify_gpg_fingerprint 2>/dev/null || true
