 ...
 *   Terms of Use → Default Browser → Marketing
 *
...
object OnboardingSelectors {
    ...
    val MARKETING_TITLE = Selector(
        strategy = SelectorStrategy.COMPOSE_BY_TEXT,
        value = getStringResource(R.string.nova_onboarding_marketing_title),
        description = "Marketing onboarding card title",
        groups = listOf("marketingCard"),
    )
