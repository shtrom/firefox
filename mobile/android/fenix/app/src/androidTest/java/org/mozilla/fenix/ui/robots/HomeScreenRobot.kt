...
class HomeScreenRobot(private val composeTestRule: ComposeTestRule) {
    ...
    fun clickContinueIfMarketingCardShown() {
        ...
        if (marketingCardExists) {
            ...
            verifyTheMarketingOnboardingCard()
    ...
    fun verifyTheMarketingOnboardingCard() {
        Log.i(TAG, "verifyTheMarketingOnboardingCard: Trying to verify the \"Marketing\" onboarding card title is displayed")
        composeTestRule.onNodeWithText(getStringResource(R.string.nova_onboarding_marketing_title)).assertIsDisplayed()
        Log.i(TAG, "verifyTheMarketingOnboardingCard: Verified the \"Marketing\" onboarding card title is displayed")
        Log.i(TAG, "verifyTheMarketingOnboardingCard: Trying to verify the \"Marketing\" onboarding card \"Continue\" button is displayed")
        composeTestRule.onAllNodesWithText(getStringResource(R.string.nova_onboarding_continue_button)).onFirst().assertIsDisplayed()
        Log.i(TAG, "verifyTheMarketingOnboardingCard: Verified the \"Marketing\" onboarding card \"Continue\" button is displayed")
    }
    ...
    fun swipeRightTheMarketingOnboardingCard() {
        Log.i(TAG, "swipeRightTheMarketingOnboardingCard: Trying to perform swipe right action on the \"Marketing\" onboarding card")
        mDevice.findObject(
            UiSelector().textContains(
                getStringResource(R.string.nova_onboarding_marketing_title),
            ),
        ).swipeRight(3)
        Log.i(TAG, "swipeRightTheMarketingOnboardingCard: Performed swipe right action on the \"Marketing\" onboarding card")
    }
